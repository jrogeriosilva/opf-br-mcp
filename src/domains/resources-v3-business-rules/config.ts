export const resourcesV3BusinessRulesConfig = {
  ...
  description:
    ...
    "para todo o major v3 — e Campos regulatórios (obrigatoriedade regulatória dos campos da resposta de " +
    "GET /resources). " +
  ...
  pages: [
    ...
    { pageId: "219480528", title: "Campos regulatórios - [DC] Recursos" },
  ],
};

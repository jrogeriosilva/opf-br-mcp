...
export const enrollmentsV2Config: OpenApiDomainConfig = {
  ...
  title: "API de Vínculo de Dispositivo (Enrollments) — spec OpenAPI 2.3.0",
  description:
  ...
  specVersion: "2.3.0",
  url: "https://raw.githubusercontent.com/OpenBanking-Brasil/all-services-repo/refs/heads/main/api_enrollments_for_payment_initiation_-_open_finance_brasil/2.3.0.yaml",

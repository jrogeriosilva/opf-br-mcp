...
export const consentsV3Config: OpenApiDomainConfig = {
  ...
  description:
    ...
    "É o consentimento de dados — não cobre consentimento de pagamento, que fica em payments-v5-openapi (/consents) e automatic-payments-v2-openapi (/recurring-consents). " +
